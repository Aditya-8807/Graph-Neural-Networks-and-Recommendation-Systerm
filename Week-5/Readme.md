...
* [CS224W Playlist](https://www.youtube.com/playlist?list=PLoROMvodv4rPLKxIpqhjhPgdQy7imNkDn) — the exact same derivation, walked through slower, with diagrams.
*  [Graph Convolutional Networks (GCN) | GNN Paper Explained — AI Epiphany](https://www.youtube.com/watch?v=VyIOfIglrUM) — a 44-min line-by-line walk through the same paper you're reading. Great for confirming you got the derivation right.
